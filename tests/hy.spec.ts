...
//         const fromAccountNumber = await openNewAccountPage.getFirstFromAccountNumber();
//         console.log('First From Account Number:', fromAccountNumber);
...
//          //logger.info(`Iniciation of the API testing with ${fromAccountNumber}`);
//          console.log("ACCOUNT ID:", fromAccountNumber);
//         const response = await accountsAPI.getAccounts(fromAccountNumber);
