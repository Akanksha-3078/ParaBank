...
- Name: AApi.spec.ts >> GET Accounts API Validation >> @regression @api (TC-API-05, TC-API-03, TC-API-04) Validate Create Account API using GET response data
- Location: tests/AApi.spec.ts:17:5
